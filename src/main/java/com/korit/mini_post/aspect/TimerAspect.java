package com.korit.mini_post.aspect;
...
public class TimerAspect {
    ...
    @Pointcut("execution(* com.korit.mini_post.service.PostService.getPostById(..))")
    private void executionPointCut() {}

    // 해당 어노테이션이 달려있는 위치로 pointcut 지정
    @Pointcut("@annotation(com.korit.mini_post.aspect.annotation.TimerAop)")
